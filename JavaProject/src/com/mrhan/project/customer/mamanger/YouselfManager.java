					...
					CustomerInfo ci =customer;
						...
						for(OrderInfo oi : allorder){
							...
							for(OrderGoodsInfo ogi : allg){
								...
								out(2,"\t");out(ogi.getNum());
								out(2,"\t");outln(ogi.getNum()*ogi.getGoodsInfo().getPrice()*ogi.getGoodsInfo().getDiscount());
							}
							outln(100,"——");
							ln();
						}
